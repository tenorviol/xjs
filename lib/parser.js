    ...
    parse: function(input) {
      ...
      function parse_Xjs() {
        ...
        var result0 = result1 !== null
          ? (function(literal) { return literal })(result1[1])
          : null;
      ...
      function parse_XjsLiteral() {
        ...
        var savedPos0 = pos;
        var result2 = parse_XjsOuterElement();
        if (result2 !== null) {
          var result3 = [];
          var savedPos1 = pos;
          var result5 = [];
          ...
          if (result5 !== null) {
            var result6 = parse_XjsOuterElement();
            if (result6 !== null) {
      ...
      function parse_XjsOuterElement() {
        var cacheKey = 'XjsOuterElement@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_XjsInnerElements() {
        var cacheKey = 'XjsInnerElements@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        var result0 = [];
        var result3 = parse_XjsOuterElement();
        if (result3 !== null) {
          var result1 = result3;
        } else {
      ...
      function parse_XmlTag() {
        ...
        var savedPos0 = pos;
        var result2 = parse_XmlOpenTag();
        if (result2 !== null) {
          var result3 = parse_XjsInnerElements();
          if (result3 !== null) {
            var result4 = parse_XmlCloseTag();
            if (result4 !== null) {
              var result1 = [result2, result3, result4];
            } else {
              var result1 = null;
      ...
      function parse_XmlOpenTag() {
        ...
        if (result2 !== null) {
          var result3 = parse_XmlGenericId();
          if (result3 !== null) {
            var result4 = parse_XmlAttributes();
            if (result4 !== null) {
              if (input.substr(pos, 1) === ">") {
                var result5 = ">";
                pos += 1;
      ...
      function parse_XmlAttributes() {
        ...
        if (result3 !== null) {
          ...
          if (result4 !== null) {
            ...
            if (result5 !== null) {
              var result6 = parse_XmlAttributeValue();
              if (result6 !== null) {
      ...
      function parse_XmlAttributeValue() {
        ...
        var result11 = result12 !== null
          ? (function(value) { return value.join(''); })(result12[1])
          : null;
        if (result11 !== null) {
      ...
      function parse__() {
        ...
        if (result5 !== null) {
          ...
          var result4 = parse_MultiLineCommentNoLineTerminator();
          if (result4 !== null) {
            var result2 = result4;
          } else {
            var result3 = parse_SingleLineComment();
            if (result3 !== null) {
              var result2 = result3;
            } else {
              var result2 = null;;
