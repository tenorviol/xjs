    ...
    parse: function(input) {
      ...
      function parse_xj() {
        ...
        if (result5 !== null) {
          ...
          var result4 = parse_emptyTag();
          if (result4 !== null) {
            var result1 = result4;
          } else {
            var result3 = parse_PCDATA();
            if (result3 !== null) {
              var result1 = result3;
            } else {
              var result2 = parse_script();
              if (result2 !== null) {
                var result1 = result2;
              } else {
                var result1 = null;;
      ...
      function parse_attrValue() {
        ...
        if (result7 !== null) {
          ...
          var result2 = result3 !== null
            ? (function(value) { return value.join(''); })(result3[1])
            : null;
          if (result2 !== null) {
            var result0 = result2;
          } else {
            var result1 = parse_script();
            if (result1 !== null) {
              var result0 = result1;
            } else {
              var result0 = null;;
