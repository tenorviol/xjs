  ...
  var result = {
    ...
    parse: function(input) {
      ...
      function parse_XjsLiteral() {
        ...
        var savedPos0 = pos;
        var result2 = parse_XjsLiteralElement();
        if (result2 !== null) {
          var result3 = [];
          var savedPos1 = pos;
          var result5 = [];
          ...
          if (result5 !== null) {
            var result6 = parse_XjsLiteralElement();
            if (result6 !== null) {
      ...
      function parse_XmlPCDATA() {
        ...
        if (result8 !== null) {
          ...
          var result3 = result4 !== null
            ? (function(first, second) { return first + second; })(result4[0], result4[1])
            : null;
          if (result3 !== null) {
            var result2 = result3;
          } else {
